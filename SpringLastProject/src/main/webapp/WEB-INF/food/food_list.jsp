...
<body>
	<div class="wrapper row3" id="foodApp"> <!-- 여기에 id를 줘야 쿠키까지 div안에 들어감 -->
	  <main class="container clear"> 
	    <!-- main body -->
	    <h2 class="sectiontitle">맛집 목록</h2>
	    <div class="content"> <!-- id가 여기 있었는데 그러면 쿠키 부분에는 Vue가 적용이 안됨 그래서 위로 올림 -->
	      <div id="gallery">
	        <figure>
	    ...
	    <div>
	    	...
	    	<span v-for="vo in cookie_list">
	    	  <a :href="'../food/food_list_detail.do?fno='+vo.fno">
	    		<img :src="'http://menupan.com'+vo.poster" style="width: 100px; height: 100px; margin-left: 5px">
	    	  </a>
	    	</span>
	    </div>
	  </main>
