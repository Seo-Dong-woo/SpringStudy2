      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            <li v-for="(vo,index) in recipe_list" :class="index%4==0?'one_quarter first':'one_quarter'"><a :href="'../recipe/recipe_detail.do?fno='+vo.no"><img :src="vo.poster" :title="vo.title"></a></li>
          </ul>
