...
public class MainRestController {
	...
	public String member_login(String id, String pwd, HttpSession session) // 매개변수와 main의 axios.get('../member/login_vue.do', {params:{id:this.id,pwd:this.pwd}})의 params의 매개변수가 같아야 함
	{
